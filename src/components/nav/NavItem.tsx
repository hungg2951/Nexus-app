...
const NavItem: FC<NavItemProps> = ({ icon, label, active = false, badge, href = "/" }) => (
  ...
  >
    ...
    {badge !== undefined && (
      <span className="absolute right-2 lg:right-4 top-2 lg:top-1/2 lg:-translate-y-1/2 bg-primary text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none">
        {badge}
      </span>
    )}
  </Link>
